...
public class Evento implements Serializable {
    ...
    public Evento nombreEvento(Integer nombreEvento) {
    ...
    public Evento categoria(Categoriad categoria) {
    ...
    public Evento tipoEvento(Integer tipoEvento) {
    ...
    public Evento grupos(Set<Grupos> grupos) {
        this.grupos = grupos;
        return this;
    }

    public Evento addGrupos(Grupos grupos) {
        this.grupos.add(grupos);
        grupos.setEvento(this);
        return this;
    }

    public Evento removeGrupos(Grupos grupos) {
        this.grupos.remove(grupos);
        grupos.setEvento(null);
        return this;
    }
    ...
    public Evento miembros(Miembros miembros) {
