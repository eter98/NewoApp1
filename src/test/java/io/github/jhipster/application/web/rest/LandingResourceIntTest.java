...
public class LandingResourceIntTest {
    ...
    private static final Boolean DEFAULT_IVA = false;
    private static final Boolean UPDATED_IVA = true;
    ...
    public void createLanding() throws Exception {
        ...
        assertThat(testLanding.isIva()).isEqualTo(DEFAULT_IVA);
    }
    ...
    public void getAllLandings() throws Exception {
        ...
        restLandingMockMvc.perform(get("/api/landings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].iva").value(hasItem(DEFAULT_IVA.booleanValue())));
    }
    ...
    public void getLanding() throws Exception {
        ...
        restLandingMockMvc.perform(get("/api/landings/{id}", landing.getId()))
            ...
            .andExpect(jsonPath("$.iva").value(DEFAULT_IVA.booleanValue()));
    }
    ...
    public void updateLanding() throws Exception {
        ...
        assertThat(testLanding.isIva()).isEqualTo(UPDATED_IVA);
    }
