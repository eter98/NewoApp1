...
public class BlogResourceIntTest {
    ...
    private static final Integer DEFAULT_TIPO_CONTENIDO = 1;
    private static final Integer UPDATED_TIPO_CONTENIDO = 2;
    ...
    public void createBlog() throws Exception {
        ...
        assertThat(testBlog.getCategoria()).isEqualTo(DEFAULT_CATEGORIA);
    ...
    public void updateBlog() throws Exception {
        ...
        assertThat(testBlog.getCategoria()).isEqualTo(UPDATED_CATEGORIA);
