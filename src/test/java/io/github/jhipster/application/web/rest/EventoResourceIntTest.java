...
public class EventoResourceIntTest {
    ...
    private static final Integer DEFAULT_NOMBRE_EVENTO = 1;
    private static final Integer UPDATED_NOMBRE_EVENTO = 2;
    ...
    private static final Categoriad DEFAULT_CATEGORIA = Categoriad.GENERAL;
    private static final Categoriad UPDATED_CATEGORIA = Categoriad.DE_GRUPO;

    private static final Integer DEFAULT_TIPO_EVENTO = 1;
    private static final Integer UPDATED_TIPO_EVENTO = 2;
    ...
    public void createEvento() throws Exception {
        ...
        assertThat(testEvento.getCategoria()).isEqualTo(DEFAULT_CATEGORIA);
    ...
    public void updateEvento() throws Exception {
        ...
        assertThat(testEvento.getCategoria()).isEqualTo(UPDATED_CATEGORIA);
